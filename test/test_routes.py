...
#     response = client.get('/save_emails/1')
#     assert response.status_code == 200
...
# def test_get_email_by_invalid_id(client):
#     response = client.get('/save_emails/999')
#     assert response.status_code == 404

# def test_delete_email(client):
#     response = client.delete('/save_emails/1')
#     assert response.status_code == 200
#     assert 'message' in response.json

# def test_delete_email_by_invalid_id(client):
#     response = client.delete('/save_emails/999')
#     assert response.status_code == 404
